...
import { deleteProduct, deleteProductImage, getLatestProducts, getlistings, getProductDetails, getProductsByCategory, listNewProduct, updateProduct } from 'src/controllers/product';
...
productRouter.get('/details:/id',isAuth,getProductDetails)
productRouter.get(':/by-category/"category',getProductsByCategory)
productRouter.get('/latest',getLatestProducts)
productRouter.get('/listing',isAuth,getlistings)
